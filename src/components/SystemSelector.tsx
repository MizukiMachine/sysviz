...
export function SystemSelector({
  ...
  return (
    <div className="fixed top-5 left-5 z-20 flex w-[248px] max-w-[calc(100%_-_176px)] min-w-0 flex-col gap-2 px-3.5 py-3.5 glass-panel">
      <label
        ...
        <div className="flex flex-col gap-2 pt-1">
          <div className="flex gap-2">
            <button
              ...
              className="ui-focus-ring flex-1 inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200/60 bg-white/60 px-3 py-2 text-xs font-semibold text-slate-600 transition-colors hover:bg-white/80 disabled:cursor-not-allowed disabled:opacity-60"
            >
            ...
            <button
              ...
              className="ui-focus-ring flex-1 rounded-xl border border-blue-200/60 bg-blue-50 px-3 py-2 text-xs font-semibold text-blue-700 transition-colors hover:bg-blue-100 disabled:cursor-not-allowed disabled:opacity-60"
            >
