...
export function ChatPanel({
  ...
  return (
    <>
      {!showSettings && (
        <div
          className="fixed top-0 right-0 z-30 h-full flex flex-col border-l border-white/50 bg-white/45 shadow-[-20px_0_50px_rgba(15,23,42,0.10)] backdrop-blur-xl animate-slide-in-right"
        ...
        >
          ...
          <div
            ...
            className="absolute top-0 left-0 z-10 hidden h-full w-1.5 cursor-col-resize transition-colors hover:bg-blue-400/30 active:bg-blue-400/50 sm:block"
          />
          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-slate-200/30">
            ...
            <div className="flex items-center gap-1.5">
              <button
                type="button"
                onClick={onClearChat}
                className="ui-focus-ring p-3 rounded-lg border border-transparent text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-colors cursor-pointer"
